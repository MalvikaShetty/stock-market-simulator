...
var Dashboard2 = function (_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, userTradesData !== null ? (react_1["default"].createElement("div", { className: "m-4 p-4 border rounded-lg" },
        react_1["default"].createElement("p", { className: "text-md mb-2" },
            "Amount Invested Total: $",
            userTradesData.trades.reduce(function (total, trade) { return total + trade.amountInvested; }, 0)),
        react_1["default"].createElement("p", { className: "text-lg font-semibold mb-2" }),
        react_1["default"].createElement("p", { className: "text-lg font-semibold mb-2" },
            "Total Unrealized Gain/Loss: ",
            react_1["default"].createElement("span", { style: { color: totalUnrealizedGainLoss < 0 ? 'red' : 'green' } },
                "$",
        ...
        react_1["default"].createElement("table", { className: "border-collapse border border-green-800" },
            ...
            react_1["default"].createElement("tbody", null, userTradesData.trades.length > 0 ? (userTradesData.trades.map(function (entry, index) { return (react_1["default"].createElement("tr", { key: index },
                ...
                react_1["default"].createElement("td", { className: "border border-green-800 px-4 py-2 " + ((entry.quantity * getCurrentPrice(entry.stockSymbol) - entry.amountInvested) < 0 ? 'text-red-500' : 'text-green-500') },
                    "$",
