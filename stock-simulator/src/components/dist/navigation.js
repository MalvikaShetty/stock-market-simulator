...
var Navigation = function (_a) {
    ...
    return (react_1["default"].createElement("nav", { className: "bg-black text-white p-4 flex space-x-8" },
        ...
        !isLoggedIn && (react_1["default"].createElement(react_router_dom_1.Link, { to: "/login", className: "text-lg hover:text-blue-500 transition duration-300 mt-4" }, "Login"))));
};
